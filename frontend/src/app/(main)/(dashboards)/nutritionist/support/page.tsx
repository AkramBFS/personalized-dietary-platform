      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <Card className="md:col-span-2 shadow-sm">
          <CardHeader>
            ...
            <CardDescription className="text-muted-foreground">Describe your issue and our team will get back to you via your registered email.</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={submitFeedback} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className="w-full min-h-[180px] p-3 text-sm rounded-md border border-border bg-background text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                />
              </div>
          ...
          <Card className="shadow-sm">
            <CardContent className="p-6 space-y-4">
              ...
              <div className="space-y-3">
                <a href="#" className="flex items-center gap-3 p-3 rounded-lg bg-muted/50 border border-border hover:border-primary/50 transition-colors group">
