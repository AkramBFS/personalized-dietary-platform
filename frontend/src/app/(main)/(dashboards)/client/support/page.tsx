      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <Card className="md:col-span-2 shadow-sm">
          <CardHeader>
            ...
            <CardDescription>
              Describe your issue and our team will get back to you via your
              registered email.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={submitFeedback} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className="w-full min-h-[180px] p-3 text-sm rounded-md border border-input bg-input text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                />
              </div>
              <Button
                type="submit"
        ...
        <div className="space-y-4">
          ...
          <Card className="shadow-sm">
            <CardContent className="p-6 text-center space-y-3">
              ...
              <a
                href="mailto:support@nutriplatform.com"
