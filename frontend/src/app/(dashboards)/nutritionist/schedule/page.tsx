...
export default function SchedulePage() {
  ...
  const handleAddHoliday = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setHolidays([
        ...holidays,
        { id: created.id, date: created.holiday_date },
      ]);
                ...
                <Card className="border-border shadow-sm h-fit">
                  <form onSubmit={handleAddHoliday}>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Block off specific dates to prevent consultation
                        bookings.
                      </CardDescription>
                    </CardHeader>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex space-x-2">
                          <Input
                            ...
                            onChange={(e) =>
                              setHolidayDateInput(e.target.value)
                            }
              ...
              <div className="space-y-4">
                ...
                >
                  <div className="space-y-3">
                    <Label htmlFor="zoom" className="font-bold text-foreground">
